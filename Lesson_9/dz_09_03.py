...
# A width  - це ширина, топто висота. Також сказано що одна діагональ перпендікулярона стороні,
# а це значить що паролілограм утворюється двома, прямоуголими рівнобеденними трикутниками.
